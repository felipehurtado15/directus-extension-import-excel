export const messages = {
  ...
  'en-US': {
    ...
    keyFieldTitle: 'Optional: Key Fields for Upsert',
    keyFieldLabel: 'Key fields (unique)',
    keyFieldHelp1: 'These fields will be used to identify and update existing items during import. You can select multiple fields to create a composite key.',
    selectKeyFieldPlaceholder: 'Select key fields',
  ...
  'fr-FR': {
    ...
    keyFieldTitle: '🗝️ (Facultatif) - Choisissez les champs clés pour la mise à jour',
    keyFieldLabel: 'Champs clés (uniques)',
    keyFieldHelp1:
      'Facultatif : Ces champs seront utilisés pour identifier et mettre à jour les éléments existants lors de l\'import. Vous pouvez sélectionner plusieurs champs pour créer une clé composite.',
    keyFieldHelp2:
      'Les champs doivent être uniques dans la collection cible.',
  ...
  'es-ES': {
    ...
    keyFieldTitle: '🗝️ (Opcional) - Elija los campos clave para actualización',
    keyFieldLabel: 'Campos clave (únicos)',
    keyFieldHelp1:
      'Opcional: Estos campos se utilizarán para identificar y actualizar elementos existentes durante la importación. Puede seleccionar múltiples campos para crear una clave compuesta.',
    keyFieldHelp2:
      'Los campos deben ser únicos en la colección de destino.',
  ...
  'tr-TR': {
    ...
    keyFieldTitle: '🗝️ (İsteğe bağlı) - Güncelleme için ana alanları seçin',
    keyFieldLabel: 'Anahtar alanlar (benzersiz)',
    keyFieldHelp1: 'İsteğe bağlı: Bu alanlar, içe aktarma sırasında mevcut öğeleri tanımlamak ve güncellemek için kullanılacaktır. Bileşik anahtar oluşturmak için birden fazla alan seçebilirsiniz.',
    keyFieldHelp2: 'Alanlar, hedef koleksiyonda benzersiz olmalıdır.',
    keyFields: 'Anahtar alanlar',
